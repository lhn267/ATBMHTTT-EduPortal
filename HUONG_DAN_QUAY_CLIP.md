...
- **Lời thoại A:** *"Dạ, em lấy từ API của hệ thống ạ. Ví dụ giảng viên này có mã 12 thì đường dẫn là: http://localhost:3000/api/giangvien/12 (hoặc link Render: .../api/giangvien/12) nè cô."*
