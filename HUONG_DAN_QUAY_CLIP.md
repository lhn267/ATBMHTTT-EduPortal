...
## I. HƯỚNG DẪN KHỞI ĐỘNG VÀ QUẢN LÝ QUAY (1-CLICK)

1. **Khởi động hệ thống:**
   - Vào thư mục `C:\Users\User\ATBMHTTT`
   - Nhấp đúp chuột vào file **`run.bat`**
   - Hệ thống sẽ tự động bật 2 server (EduPortal cổng `3000` và Server tấn công cổng `4000`) và tự động mở trình duyệt vào trang đăng nhập: `http://localhost:3000/login`.
2. **Nếu quay hỏng một cảnh (Cần quay lại take mới):**
   - Nhấp đúp chuột vào file **`reset_data.bat`**
   - Dữ liệu (bình luận, trạng thái đề tài, thông báo) sẽ lập tức trở về trạng thái ban đầu để diễn viên quay lại ngay!
...
- **Lời thoại B:** *"Sắp báo cáo tiến độ rồi, cho cô xem tổng quan đi em."*
...
- **Thao tác trên máy:**
  - Bấm vào menu **"Khóa Học MOOC"** (hoặc truy cập `http://localhost:3000/mooc`).
...
- **Lời thoại A:** *(Giật mình rồi bật cười)* *"Ủa gõ ký tự lạ mà nó chạy thành popup luôn kìa, chắc em quên lọc mấy ký tự đặc biệt. Kệ đi cô, không ảnh hưởng chức năng chính đâu."*
- **Lời thoại B:** *(Nhìn đồng hồ)* *"Thôi để ý sau nhé, giờ demo tiếp phần nộp minh chứng....."*
...
- **Lời thoại C:** *"Dạ được cô."*

#### 3. Sửa ID trên URL để xem điểm nhóm khác - IDOR (Lỗi 3)
- **Lời thoại C:** *"Chức năng xem điểm... để test thử coi có bug gì không."*
- **Thao tác trên máy (C làm):**
  - Mở trang điểm: `http://localhost:3000/diem?ma_de_tai=104`
  - Màn hình hiện: Điểm của nhóm C (*Đề tài #104 - 4.0 điểm - Không đạt / Rớt đề tài*).
  - C bôi đen số `104` trên thanh địa chỉ URL, sửa thành: `105` rồi nhấn **Enter** (`http://localhost:3000/diem?ma_de_tai=105`).
- **Màn hình hiển thị:** Lập tức hiện bảng điểm của nhóm khác (*Đề tài #105 - 9.0 điểm - Đạt / Được duyệt*).
- **Lời thoại C:** *"Dễ vậy luôn hả, đổi mỗi con số thôi mà. (Khựng lại, sững sờ) Ơ, đề tài mình bị rớt mà nhóm khác được duyệt... (Im lặng một lúc) ...thôi, test tiếp đã."*

#### 4. Module minh chứng cho phép upload file PHP (Lỗi 4)
- **Lời thoại C:** *"Mà khoan... nếu điểm với thông tin đề tài của nhóm khác còn xem được, không biết mấy chỗ khác có kiểm tra kỹ hơn không."*
- **Thao tác trên máy:**
  - Bấm vào menu **"Nộp Minh Chứng"** (`http://localhost:3000/minhchung`).
...
- **Lời thoại C:** *(Ồ lên khe khẽ)* *"Up lên được thiệt luôn? Nó đâu có kiểm tra đuôi file gì đâu ta..."*

#### 5. Đường dẫn file dính Directory Traversal (Lỗi 5)
- **Lời thoại C:** *"Upload được file gì cũng cho qua... vậy cái chỗ đọc tài liệu này có kiểm tra đường dẫn không?"*
- **Thao tác trên máy:**
  - Bấm vào menu **"Tài Liệu"** (`http://localhost:3000/tailieu?file=huong_dan_khoa_luan.pdf` hoặc `/view?file=...`).
- **Lời thoại C:** *"Có tham số file luôn..."*
- **Thao tác trên máy:**
...
- **Lời thoại C:** *"Wow. Đi vòng vòng vậy mà đọc được cả file trên server luôn á?"*
...
- **Lời thoại C:** *"Ủa, có tài liệu mới hả? Để coi thử."*
- **Thao tác trên máy:**
...
- **Lời thoại C:** *"Ủa gì vậy? Mình có làm gì đâu? Để mở DevTools lên xem thử... Khoan... Mình đang coi tài liệu thôi mà? Sao bên EduPortal lại vừa có thao tác?"*
- **Thao tác trên máy:** Chuyển sang tab EduPortal (`http://localhost:3000/dashboard.html`). Màn hình hiện thông báo mới: *"Cập nhật thành công"*.
- **Lời thoại C:** *"Vậy là web bên ngoài vừa khiến EduPortal thực hiện thao tác bằng phiên đăng nhập của mình? Để note lại lỗi này."*

#### 7. Hiển thị chi tiết lỗi truy vấn SQL ra màn hình (Lỗi 7)
- **Lời thoại C:** *"Test tới đây coi như tạm ổn phần chính. Còn cái ô tìm mã sinh viên nữa..."*
- **Thao tác trên máy:**
  - Vào trang **"Tìm Kiếm"** (`http://localhost:3000/timkiem`).
...
- **Lời thoại C:** *"Cái gì đây... nó hiện luôn cả cấu trúc bên trong. Web này đúng kiểu cái gì cũng để lộ."*

#### 10. Để lộ mật khẩu kết nối Database trong file HTML (Lỗi 10)
- **Lời thoại C:** *"Test xong phần tìm kiếm rồi, giờ qua trang thông tin chung coi UI ổn không."*
- **Thao tác trên máy:**
  - Vào trang **"Thông Tin Chung"** (`http://localhost:3000/thong-tin`).
...
- **Màn hình hiển thị:** Thấy dòng chú thích của lập trình viên:
  ...
  ```
- **Lời thoại C:** *(Dừng lại, bất ngờ)* *"...cái này là gì vậy? Thông tin đăng nhập database nằm ngay trong code gửi về trình duyệt luôn á? (C định nhắn báo ngay cho A, rồi khựng lại, chụp màn hình lưu riêng) ...để coi thử cái này dùng được gì không đã, báo sau."*

#### 11. Lộ cấu trúc thư mục Git ra môi trường web (Lỗi 11)
- **Lời thoại C:** *"Thử coi cái thư mục git lúc đẩy code lên server còn sót không ha."*
- **Thao tác trên máy:**
...
- **Lời thoại C:** *"Còn luôn á? Vậy ai rảnh cũng lấy được nguyên code tụi mình viết luôn chứ gì. (Lại định báo rồi thôi) Thôi, để tổng hợp một lượt rồi báo luôn cho gọn."*

#### 12. Cấu hình CORS lỏng lẻo cho phép mọi domain gọi API (Lỗi 12)
- **Lời thoại C:** *"Để coi API có cho website bên ngoài đọc dữ liệu không."*
- **Thao tác trên máy:**
...
- **Lời thoại C:** *"Ơ... trang ngoài EduPortal mà vẫn đọc được response API luôn? Để lưu lại lỗi này luôn."*
...
- **Màn hình hiển thị:** Xuất hiện dòng cảnh báo màu vàng:
  ...
  ```
- **Lời thoại C:** *"Ủa sao Console cứ cảnh báo cái này vậy ta."*
- **Thao tác trên máy:** Mở Google gõ thử `jQuery 1.8.3 CVE`.
- **Lời thoại C:** *(Trầm ngâm)* *"Thư viện cũ vậy mà tụi mình vẫn còn dùng à... đúng ra phải update lâu rồi."*

#### 14. Mã JWT Token sinh ra không được kiểm tra chữ ký (Lỗi 14)
- **Thao tác trên máy:**
  - Mở DevTools (**F12**) → tab **Application** → chọn **Local Storage** → `http://localhost:3000`.
  - Xem giá trị của key `edu_jwt_token`.
- **Lời thoại C:** *"Để coi token này được xác thực kiểu gì."*
- **Thao tác trên máy:**
  - Payload hiện tại đang là `role: "sinhvien"`.
  - C copy token đã sửa thành `role: "admin"`:
    ```
    eyJhbGciOiJub25lIiwidHlwIjoiSldUIn0.eyJtYV9zdiI6IlNWMDAxIiwicm9sZSI6ImFkbWluIn0.
    ```
  - C dán đè vào ô Value trong Local Storage (hoặc mở trang `http://localhost:3000/admin`).
- **Màn hình hiển thị:** Server trả về **200 OK**, trang Quản trị viên (`/admin`) mở ra với đầy đủ thông số hệ thống cấp cao!
- **Lời thoại C:** *"Khoan... Token bị sửa rồi mà server vẫn chấp nhận? Vậy backend không kiểm tra chữ ký token đúng cách rồi."*
...
- **Thao tác trên máy:**
  - B mở mục **"Giảng Viên"** (`http://localhost:3000/giangvien`).
- **Lời thoại B:** *"Để cô xem thử phần thông tin giảng viên. Em bấm vào cô này cho cô coi."*
- **Thao tác trên máy:** A bấm vào thẻ giảng viên mã số 12.
- **Lời thoại B:** *"Ừ, phần này hiện bình thường. Nhưng dữ liệu này lấy ở đâu vậy em?"*
- **Lời thoại A:** *"Dạ, em lấy từ API của hệ thống ạ. Ví dụ giảng viên này có mã 12 thì đường dẫn là: http://localhost:3000/api/giangvien/12 nè cô."*
- **Lời thoại B:** *"Vậy để cô thử mở thẳng đường dẫn đó xem."*
- **Thao tác trên máy:**
  - B copy link `http://localhost:3000/api/giangvien/12`.
...
- **Màn hình hiển thị:** Màn hình trả về trực tiếp chuỗi JSON:
  ...
  ```
- **Lời thoại B:** *"Ủa? Không đăng nhập mà vẫn xem được? Với nó trả cả số điện thoại với địa chỉ luôn này."*
- **Lời thoại A:** *"Chắc lúc làm API em cho nó trả hơi nhiều dữ liệu."*
- **Lời thoại B:** *"Ừ, cái này phải coi lại. Người ngoài đâu được biết hết mấy thông tin này."*
- **Lời thoại A:** *"Dạ... để em sửa sau ạ."*

#### 9. Không giới hạn số lần nhập sai mật khẩu - Brute-Force (Lỗi 9)
- **Thao tác trên máy:** B mở lại trang đăng nhập `http://localhost:3000/login`.
- **Lời thoại B:** *"Để cô thử thêm cái này."*
- **Thao tác trên máy:**
...
- **Lời thoại B:** *"Sao nhập sai cả chục lần mà nó không khóa tài khoản vậy?"*
- **Lời thoại A:** *(Bận gõ chỗ khác)* *"Dạ để em thêm sau, giờ deadline gấp quá cô ơi."*

#### 15. Bật chế độ Debug hiển thị lỗi trên server thật (Lỗi 15)
- **Thao tác trên máy:** A bấm vào liên kết **"Kiểm tra Báo cáo Lỗi Máy chủ"** (`http://localhost:3000/debug-error`).
...
- **Lời thoại A:** *"Ủa sao lỗi này lại hiện chi tiết vậy ta..."*
- **Lời thoại B:** *"Chắc do em để chế độ debug từ hồi code cho dễ tìm lỗi, quên tắt lại khi đẩy lên server thật rồi."*
- **Lời thoại A:** *(Gãi đầu)* *"Dạ, để em tắt."*  
...
- **Thao tác trên máy:**
  - B mở DevTools (**F12**) → tab **Network** → chọn request trang chủ `http://localhost:3000/` → phần **Response Headers**.
- **Lời thoại B:** *"Để cô kiểm tra mấy HTTP header bảo mật xem."*
- **Màn hình hiển thị:** Headers hoàn toàn không có `X-Frame-Options` hay `Content-Security-Policy`.
- **Lời thoại B:** *"Không thấy X-Frame-Options, cũng không có frame-ancestors."*
- **Lời thoại A:** *"Hai cái đó dùng để ngăn trang bị nhúng vào iframe đúng không cô?"*
- **Lời thoại B:** *"Ừ. Để cô thử luôn."*
- **Thao tác trên máy:**
...
- **Lời thoại B:** *"Nhúng vào bình thường thật rồi này. Lỡ ai làm giả một trang y hệt rồi nhúng cái này vào, sinh viên đâu biết mình đang bấm nhầm trang giả."*
- **Lời thoại A:** *"Dạ, để em note lại lỗi."*
...
- **Lời thoại B:** *(Xem link, thấy đoạn &session=8f3a1c9d0e ngay giữa URL)* *"Cái này... sao đường link đọc tài liệu bình thường lại có nguyên đoạn mã phiên đăng nhập của em nằm ngay trên URL vậy?"*
- **Lời thoại A:** *(Chợt hiểu, mặt tái đi)* *"Ủa... vậy ai có cái link này là vào được tài khoản em luôn?"*
- **Lời thoại B:** *"Link này còn có thể bị lưu vào lịch sử trình duyệt, log hoặc bị chia sẻ nhầm nữa."*

#### 18. Không tự động thu hồi Cookie/Session khi đăng xuất (Lỗi 18)
- **Lời thoại B:** *"Để cô test thử coi sau khi đăng xuất session đó còn dùng được không."*
- **Thao tác trên máy:**
  - A bấm nút **"Đăng xuất"** trên giao diện EduPortal.
  - B mở một cửa sổ ẩn danh khác (hoặc trình duyệt khác), dán lại đường link cũ:  
    `http://localhost:3000/dashboard?session=8f3a1c9d0e` và nhấn Enter.
- **Màn hình hiển thị:** Vẫn vào thẳng tài khoản A như bình thường dù vừa đăng xuất!
- **Lời thoại B:** *(Thở dài)* *"Đăng xuất hẳn hoi rồi mà phiên cũ vẫn còn dùng được á. Đăng xuất coi như chỉ đóng giao diện thôi, chứ đâu thật sự khóa lại gì đâu."*
...
- **Hành động (Phân cảnh hồi tưởng hoặc C thao tác):**
  ...
  - C vào trang đề tài của mình: `http://localhost:3000/detai`.
...
- **Lời thoại C:** *"Ủa... sửa được thật à..."* *(C nhìn màn hình một lúc rồi lặng lẽ đóng DevTools).*
...
- **Lời thoại C:** *(Nghẹn ngào, ngồi sụp xuống ghế)* *"Dạ... em xin lỗi cô, xin lỗi A. Em test giùm mà phát hiện toàn lỗi, em định báo lại... nhưng em đang trượt đề tài, em sợ quá nên..."*
- **Lời thoại B:** *(Giọng trầm, nghiêm nghị nhưng ấm áp)* *"Quân, cô hiểu áp lực của em. Nhưng đáng lẽ ra, chính lúc em phát hiện những lỗi này trong lúc test, đó là cơ hội để em giúp cả nhóm sửa nó — không phải cơ hội để lợi dụng."*
- **Lời thoại A:** *(Thấm thía)* *"Mà đúng thật ha cô, tụi em cũng đâu phải không biết cách sửa, mà cứ mỗi lần thấy gì lạ lúc demo, tụi em đều nghĩ 'thôi kệ, để sau' rồi cho qua..."*
- **Lời thoại B:** *(Kết phim - Nhìn thẳng vào ống kính hoặc nhìn cả nhóm)* *"Và đó chính là điều nguy hiểm nhất. Không phải vì không ai biết cách sửa, mà vì không ai chịu dừng lại để sửa ngay khi vừa phát hiện điều bất thường."*
