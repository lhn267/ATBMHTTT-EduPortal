...
- **Thao tác chuyển cảnh (Rất quan trọng):**
  ...
  - C đăng nhập vào tài khoản sinh viên của mình:
    ...
    - **Mật khẩu:** `quan123`
    - Bấm nút: **"Đăng Nhập"**
  - **Màn hình hiển thị:** Chuyển vào Dashboard, góc trên bên phải hiện tên: **Lê Anh Quân (C)**.
...
- **Thao tác trên máy (C làm tuần tự):**
  ...
  2. **Lời thoại C:** *"Chỉ tài khoản admin mới vào được à... Để coi token này được xác thực kiểu gì."*
...
- **Lời thoại C:** *(Ngạc nhiên rồi sững người)* *"Khoan... Token bị sửa rồi mà server vẫn chấp nhận? Vậy backend không kiểm tra chữ ký token đúng cách rồi."*
